...
class PositionEmbeddingSine(nn.Module):
    """
    Standard version of the position embedding.
    """
    ...
    def forward(self, x, mask):
        ...
        Args:
            ...
            mask: mask tensor of shape (B, H, W) where True means ignore
        """
...
class PositionEmbeddingLearned(nn.Module):
    ...
    def __init__(self, num_pos_feats=256, num_rows=50, num_cols=50):
        super().__init__()
